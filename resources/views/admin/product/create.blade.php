    ...
    <div class="max-w-6xl mx-auto shadow p-3 mt-4 bg-white rounded">
        ...
        <form enctype="multipart/form-data" action="{{route('product.store')}}" method="POST">
            ...
            <div class="form-item-container my-2 p-2">
                ...
                <livewire:forms.upload-file :itemName="'image'" :model="'Product'" :collectionName="'product_gallery'" :acceptedFiles="'.pdf,.png,.jpg,.jpeg'" :multiple="false" :maxUploadFiles="'10'"/>
            </div>
            <div class="form-item-container my-2 p-2">
